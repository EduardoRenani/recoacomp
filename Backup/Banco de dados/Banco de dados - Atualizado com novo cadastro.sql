...
CREATE TABLE usuario (
  ...
  ativo TINYINT UNSIGNED NULL,
  hash_ativacao VARCHAR(40) NULL,
  senha_reset_hash CHAR(40) NULL,
  reset_timestamp BIGINT(20) NULL,
  lembreme_token VARCHAR(64) NULL,
  failed_login TINYINT UNSIGNED NULL,
  ultimos_failed_login INT(10) NULL,
  data_registro DATETIME NULL,
  ip_registro VARCHAR(39) NULL,
...
CREATE TABLE usuario_competencias (
  ...
  competencia_idcompetencia INTEGER UNSIGNED NOT NULL,
  conhecimento TINYINT UNSIGNED NOT NULL,
  atitude TINYINT UNSIGNED NOT NULL,
  habilidade TINYINT UNSIGNED NOT NULL,
