...
--
-- Host: 127.0.0.1
-- Generation Time: 29-Out-2015 às 16:37
...
CREATE TABLE IF NOT EXISTS `areas_conhecimento` (
  ...
  `nome_area_conhecimento` varchar(255) DEFAULT NULL
...
INSERT INTO `areas_conhecimento` (`area_conhecimento_id`, `nome_area_conhecimento`) VALUES
...
ALTER TABLE `areas_conhecimento`
 ADD PRIMARY KEY (`area_conhecimento_id`);
