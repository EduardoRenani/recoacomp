...
class CompTeste{
	...
	public function writeOAs(){
		...
		echo "<div class='recomendacao-content'>";
			...
			if ($cont != 0){
			echo "<div id='conteudo' class='conteudo clearfix' style=' height: auto; min-height: auto;'><li class='recomendacao-item' style='margin-bottom: 0;'>
						...
						"</div>
							<button type='button' class='btn-recomendacao btn-default btn-lg' style='background-color: #4AA1F7;'>
	...
	public function ordenaOAs(){
		...
		*/
		...
		var_dump($this->filtragemColaborativaGetSimilaridade());
