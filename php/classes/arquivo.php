<?php
	...
	class Arquivo {
		const TIPO_ARQUIVO_FOTO_PERFIL = 0;
		const TAMANHO_MAXIMO_ARQUIVO = 99999999999;
		const LARGURA_MAXIMA_FOTO_PERFIL = 9999999;
		const ALTURA_MAXIMA_FOTO_PERFIL = 9999999;
		...
		function __construct($tipoArquivo = null) {
			if(!is_null($tipoArquivo)) {
				...
				if($tipoArquivo == self::TIPO_ARQUIVO_FOTO_PERFIL) {
					$configuracao = array(	"tamanho" => self::TAMANHO_MAXIMO_ARQUIVO,
											"largura" => self::LARGURA_MAXIMA_FOTO_PERFIL,
											"altura" => self::ALTURA_MAXIMA_FOTO_PERFIL
											);
